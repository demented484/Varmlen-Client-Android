...
const EN: Dict = {
  ...
  "split.mode.selective": "VPN works only for the listed apps and websites. Everything else stays direct.",
  "split.mode.general": "VPN works for everything except the listed apps and websites (which stay direct).",
...
const RU: Dict = {
  ...
  "split.mode.selective": "VPN работает только для выбранных приложений и сайтов. Остальное — напрямую.",
  "split.mode.general": "VPN работает для всего, кроме выбранных приложений и сайтов (они идут напрямую).",
